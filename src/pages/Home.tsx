    ...
    <>
        ...
        <ul className="mt-16 flex flex-wrap gap-10 justify-center">
          <li className="bg-secondary bg-opacity-30 p-8 sm:p-10  rounded-lg">
            <div className="max-w-[380px] w-full min-h-[380px]">
              ...
              <p className="mt-8 text-2xl font-semibold">What is Crayola?</p>
              <p className="mt-6 text-lg leading-[1.75] font-medium">
                Crayola is a website that allows users to modify images so that
          ...
          <li className="bg-secondary bg-opacity-30 p-8 sm:p-10  rounded-lg">
            <div className="max-w-[380px] w-full min-h-[380px]">
              ...
              <p className="mt-6 text-lg leading-[1.75] font-medium">
                Crayola separates images into individual pixels and applies an
          ...
          <li className="bg-secondary bg-opacity-30 p-8 sm:p-10  rounded-lg">
            <div className="max-w-[380px] w-full min-h-[380px]">
              ...
              <p className="mt-8 text-2xl font-semibold">
                Do I have to pay for  Crayola?
              </p>
              <p className="mt-6 text-lg leading-[1.75] font-medium">
                No Way! Crayola does all the magic in your browser. There are no
      ...
      <footer className="pt-16 pb-20">
        <div className="max-w-[700px] px-4 mx-auto ">
          <p className="text-center font-bold text-3xl text-accent"> Crayola </p>
          <ul className="mt-8 flex gap-8 justify-center text-4xl">
            <a
              href="https://x.com/NityaPasrija"
              target="_blank"
            >
              <FaTwitter/>
            </a>
          ...
          <p className="text-center mt-8 font-medium">
            {" "}
            © Copyright  Crayola 2024. All Rights Reserved.
          </p>
        </div>
      </footer>
    </>
